...
Dar de alta una nueva publicación con promociones

#### Endpoint

- **Método:** POST
- **Ejemplos:** 
1. `/products/promo-post`
...
- **Método:** GET
- **Ejemplos:** 
1. `/products/promo-post/count?user_id={userId}`
...
Eliminar una publicación de un usuario

#### Endpoint

- **Método:** DELETE
- **Ejemplos:** 
1. `/user/{userId}/posts/{postId}/delete`
...
| `postId`     | int       | Número que identifica a cada publicación dentro de cada usuario|
