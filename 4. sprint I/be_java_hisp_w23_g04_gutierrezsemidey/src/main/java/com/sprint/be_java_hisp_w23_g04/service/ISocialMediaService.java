...
public interface ISocialMediaService {
    ...
    SimpleMessageDTO savePostWithPromo(PostDTO postPromo);
    PromoPostsCountDTO getPostsWithPromoFromUserId(int userId);
    SimpleMessageDTO deletePost(int postId, int userId);
}
