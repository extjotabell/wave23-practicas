...
public class UserController {
    ...
    @GetMapping("/{userId}/seller-suggestions")
    public ResponseEntity<?> getFollowSuggestions(@PathVariable int userId){
        return ResponseEntity.ok(userService.getSuggestionsToFollow(userId));
    }
