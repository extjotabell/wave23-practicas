...
public class ProductController {
    ...
    public ResponseEntity<?> getPromoPostsCount(@RequestParam(required = true) int user_id){
        return new ResponseEntity<>(iProductService.getPromoPostsCount(user_id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> netPromoPost(@RequestBody PromoPostDTO promoPost){
        return new ResponseEntity<>(iProductService.newPromoPost(promoPost), HttpStatus.OK);
    }
}
