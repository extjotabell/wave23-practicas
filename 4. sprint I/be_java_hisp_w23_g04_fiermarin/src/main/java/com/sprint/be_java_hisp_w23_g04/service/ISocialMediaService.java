...
public interface ISocialMediaService {
    ...
    SimpleMessageDTO savePromoPost(PromoPostDTO post);
    PromoPostCountDTO countPromoPost(int userId);
    ProductComparisonDTO comparePriceProduct(int productId);
    List<PostResponseDTO> searchPostByCategory(int category);
}
