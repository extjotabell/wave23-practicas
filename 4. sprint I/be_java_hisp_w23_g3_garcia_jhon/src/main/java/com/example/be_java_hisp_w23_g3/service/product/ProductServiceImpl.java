...
public class ProductServiceImpl implements ProductService{
    ...
    public PostResponseDTO postProduct(PostPromoRequestDTO postPromoRequestDTO) {
        Seller seller = getSeller(postPromoRequestDTO.getUserId());
        validateProduct(postPromoRequestDTO.getProduct().getProductId());

        Post post = createPostPromo(postPromoRequestDTO, seller);
    ...
    private Post createPostPromo(PostPromoRequestDTO postPromoRequestDTO, Seller seller) {
        Long id = productRepository.getNextId();
