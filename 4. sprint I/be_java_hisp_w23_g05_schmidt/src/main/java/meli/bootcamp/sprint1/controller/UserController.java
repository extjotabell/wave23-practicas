...
public class UserController {
  ...
  public ResponseEntity<US0011Dto> countPromoPostByUserId(@RequestParam int user_id){
    return ResponseEntity.ok(this.userService.countPromoPostByUserId(user_id));
  }
