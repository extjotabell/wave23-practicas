...
| US00010       | Llevar a cabo la publicación de un nuevo producto en promoción                                                        | Marcos Martinez Jorge Rodrigo                      |
| US00011       | Obtener la cantidad de productos en promoción de un determinado vendedor                                              | Marcos Martinez Jorge Rodrigo                      |
| US00012       | Obtener un listado de todos los productos en promoción de un determinado vendedor                                     | Marcos Martinez Jorge Rodrigo    (Sin terminar.)   |
