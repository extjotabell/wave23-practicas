...
Para ejecutar la API es necesario descargar los archivos de este repositorio y abrirlos con un IDE, de preferencia **IntelliJ IDEA** utilizando Java 17. Dentro del IDE basta con ejecutar el archivo **BeJavaHispW23G3Application** ubicado en **src/main/java/be_java_hisp_w23_g3**. La API corre por defecto en el **puerto 8080 de localhost.**
...
| US0010        | Llevar a cabo la publicación de un nuevo producto en promoción                                                        | Sebastian Ospina García                            |
| US0011        | Obtener la cantidad de productos en promoción de un determinado vendedor                                              | Sebastian Ospina García                            |
| US0012        | Obtener un listado de todos los productos en promoción de un determinado vendedor                                     | Sebastian Ospina García                            |
