...
import com.example.be_java_hisp_w23_g3.dto.request.SellerRequestDTO;
...
public class UserController {
    ...
    public ResponseEntity<FollowersListDTO> getFollowersList(@PathVariable("userId") Long userId, @RequestParam(required = false) String order) {
