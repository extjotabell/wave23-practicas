...
public class SocialMeliController {
    ...
    public ResponseEntity<?> savePromoPost(@RequestBody PromoPostDTO post){
    ...
    public ResponseEntity<?> getPromoPostCount(@RequestParam int user_id){
        return new ResponseEntity<>(socialMediaService.getPromoPostCount(user_id), HttpStatus.OK);
    }

    @GetMapping("/users/{userId}/followed/count")
    public ResponseEntity<?> getFollowedCount(@PathVariable int userId) {
        return new ResponseEntity<>(socialMediaService.getFollowedCount(userId), HttpStatus.OK);
    }
}
