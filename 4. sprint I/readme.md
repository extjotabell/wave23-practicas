...
3. Desde postman u otra herramienta importe la colección de requests de prueba. Este archivo se encuentra en :
   [Postman](https://github.com/extjotabell/wave23-practicas/tree/diaz_alfredo/4.%20sprint%20I/be_java_hisp_w23_g01/src/test/postman)


4. Ejecutar una a una las request. Estas puede encontrarlas agrupadas por Historia de Usuario.
   **IMPORTANTE:** Ejecute primero el request LoadTestData para cargar datos de prueba.
...
8. **[POST] US 0010:** Publicar un producto en promoción.

    ***Reponsable: Alfredo Tonatiuh***

      /products/promo-post

   **Ejemplo:** /products/promo-post

9. **[POST] US 0011:** Obtener la cantidad de productos en promoción de un determinado vendedor.
