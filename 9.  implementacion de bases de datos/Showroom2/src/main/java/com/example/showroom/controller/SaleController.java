...
public class SaleController {
  ...
  @GetMapping("/{number}")
  public ResponseEntity<?> getSaleById(@PathVariable String number){
    return ResponseEntity.ok(saleService.getSaleById(number));
  }

  @PutMapping("/{number}")
  public ResponseEntity<?> updateSale(@PathVariable String number, @RequestBody Sale sale){
  ...
  public ResponseEntity<?> getClothesFromSale(@PathVariable String number){
