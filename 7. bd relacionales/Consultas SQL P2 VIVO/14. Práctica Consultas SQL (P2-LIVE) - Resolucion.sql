-- 1. Mostrar todos los registros de la tabla de movies. 
 ...
 SELECT series.title AS título FROM movies_db.series AS series;
...
SELECT title FROM movies_db.movies WHERE rating > 3 AND awards > 1 AND YEAR(release_date) BETWEEN 1988 AND 2009 ORDER BY rating DESC;
