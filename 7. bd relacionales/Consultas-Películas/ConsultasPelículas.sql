...
-- como el campo estèn en español. 
...
-- Mostrar el tìtulo de las películas y el rating ordenadas por rating en forma
-- ascendente. 
SELECT title, rating FROM movies ORDER BY rating;
-- Mostrar los tìtulos de las primeras tres películas en la base de datos.
SELECT title FROM movies LIMIT 3;
-- Mostrar el top 5 de las pelìculas con mayor rating. 
...
SELECT title FROM movies WHERE rating > 3 AND awards > 1 
	AND release_date BETWEEN '1998-01-01' AND '2009-12-31' ORDER BY rating;