...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ShowList.listDetailed(garaje.listaVehiculo);
        System.out.println();

        System.out.println("-------Lista ordenada por precio------");
        garaje.listaVehiculo.stream().
        ...
        garaje.listaVehiculo.stream().filter(vehiculo -> vehiculo.getCosto() < 1000).forEach(System.out::println);
        ...
        garaje.listaVehiculo.stream().mapToDouble(Vehiculo::getCosto).average().stream().forEach(System.out::println);
