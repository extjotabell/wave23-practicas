...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        garage.listaVehiculo.stream().sorted(Comparator.comparing(Vehiculo::getCosto)).forEach(System.out::println);

        System.out.println();
        System.out.println("-------Lista ordenada por marca y precio------");
        garage.listaVehiculo.stream().sorted(Comparator.comparing(Vehiculo::getMarca).thenComparing(Vehiculo::getCosto)).forEach(System.out::println);
