...
public class Factory {
    ...
    public static UserWFollowedDto generateUserWFollowedDtoList(){
        List<UserDto> userDtoList =  new ArrayList<>();
        userDtoList.add(new UserDto(2,"Brenda Torrico"));
        userDtoList.add(new UserDto(3,"Fatima Noble"));
        userDtoList.add(new UserDto(4,"Geronimo Schmidt"));

        return new UserWFollowedDto(1,"Ailen Pereira",userDtoList);
    }
    ...
    public static NewPostDto generateNewPostDto(){
        ...
        return new NewPostDto(1, LocalDate.now(),product, 1,100.00);
    }
}
