...
public class UserControllerTest {
    ...
    void getLastPostsTest() throws Exception {
        ...
        // Obtiene el último posts para el usuario
        MvcResult result = this.mockMvc.perform(MockMvcRequestBuilders.get("/products/followed/{userId}/list", 6)
                ...
                .andExpect(jsonPath("$.posts[0].product.product_name").value("Monitor Curvo"))
                .andExpect(jsonPath("$.posts[0].product.type").value("Monitor"))
                .andExpect(jsonPath("$.posts[0].product.brand").value("Samsung"))
                .andExpect(jsonPath("$.posts[0].product.color").value("Silver"))
                .andExpect(jsonPath("$.posts[0].product.notes").value("27-inch"))
