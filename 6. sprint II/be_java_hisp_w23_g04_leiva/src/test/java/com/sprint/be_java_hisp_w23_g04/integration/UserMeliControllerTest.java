...
public class UserMeliControllerTest {
    ...
    void testFollowSellerUserByHimself() throws Exception {
        // params
        int userId = 8;
        int userIdToFollow = 8;
    ...
    void testFollowNonSellerUserByHimself() throws Exception {
        // params
        int userId = 5;
    ...
    @Disabled
    @Test
    @DisplayName("UnfollowUser successful integration test")
    void testUnfollowUserOk() throws Exception {
        // params
        int userId = 4;
        int userIdToUnfollow = 3;

        SimpleMessageDTO messageDTO = new SimpleMessageDTO("El usuario Juan Perez Id: " + userIdToUnfollow + " ya no es seguido por el usuario Sofia Gomez Id: " + userId);
        String expectedResult = writer.writeValueAsString(messageDTO);

        MvcResult result = this.mockMvc.perform(post("/users/{userId}/unfollow/{userIdToUnfollow}", userId, userIdToUnfollow))
                .andDo(print())
    ...
    @Test
    @DisplayName("UnfollowUser fails because userId not exist and throw a NotFoundException")
    void testUnfollowUserButNotExist() throws Exception {
        // params
        int userId = 99;
        int userIdToUnfollow = 99;
    ...
    @Test
    @DisplayName("UnfollowUser fails because userIdToUnfollow isn't followed by userId")
    void testUnfollowUserButNotFollowing() throws Exception {
        // params
        int userId = 6;
        int userIdToUnfollow = 1;

        SimpleMessageDTO messageDTO = new SimpleMessageDTO("El usuario con id:" + userId + " no sigue al vendedor con id:" + userIdToUnfollow);
        String expectedResult = writer.writeValueAsString(messageDTO);
    ...
    @Test
    @DisplayName("UnfollowUser fails because the IDs are zero")
    void testUnfollowUserWithIdZero() throws Exception {
        // params
        int userId = 6;
        int userIdToUnfollow = 1;
