...
import com.ospina.socialmeli.controller.UserController;
...
import com.ospina.socialmeli.util.FollowedListDTOTestDataBuilder;
...
class UserControllerTests {
    ...
    void getFollowersList_shouldThrowInvalidOrderException() {
        ...
        Mockito.doThrow(new InvalidOrderException(
