...
public class ObjectCreator {
  ...
  public static UserFollowersDTO createUserFollowersIntegration() {
    List<UserBasicDTO> followedExpectedDTO = List.of(
            new UserBasicDTO(2, "Alice Smith"),
            new UserBasicDTO(3, "Bob Jones")
    );

    UserFollowersDTO payloadResponseDTO = new UserFollowersDTO();
    payloadResponseDTO.setId(1);
    payloadResponseDTO.setUserName("John Doe");
    payloadResponseDTO.setFollowers(followedExpectedDTO);
