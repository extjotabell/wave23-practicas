...
public class TestGenerator {
    ...
    public static List<StudentDTO> getAllStudents() {
        StudentDTO stu1 = getStudentWith3Subjects("Updated Name");
        stu1.setId(3L);
        StudentDTO stu2 = getStudentWith3Subjects("Marco");
        stu2.setId(2L);
        StudentDTO stu3 = getStudentWith3Subjects("Marco");
        stu3.setId(4L);
        StudentDTO stu4 = getStudentWith3Subjects("Updated Name");
        stu4.setId(1L);

        return new ArrayList<>(List.of(stu1, stu2, stu3, stu4));
    }
